		...
		$(".cuerpoCarrito").append(
			...
			'<div clas="row itemCarrito">'+
				...
				'<div class="col-md-2 col-sm-1 col-xs-12">'+
					...
					'<p class="precioCarritoCompra text-center">COP $<span>'+item.precio+'</span></p>'+
				...
				'<div class="col-md-2 col-sm-1 col-xs-4 text-center">'+
					...
					'<p class="subTotal'+item.idProducto+' subtotales">'+
						...
						'<strong>COP $<span>'+item.precio+'</span></strong>'+
...
$(".cantidadItem").change(function(){
	...
	$(".subTotal"+idProducto).html('<strong>COP $<span>'+(cantidad*precio)+'</span></strong>');
...
for(var i = 0; i < precioCarritoCompra.length; i++){
	...
	$(".subTotal"+idProductoArray).html('<strong>COP $<span>'+(precioCarritoCompraArray*cantidadItemArray)+'</span></strong>')
...
function sumaSubtotales(){
	...
	$(".sumaSubTotal").html('<strong>COP $<span>'+sumaTotal+'</span></strong>');
...
function divisas(metodoPago){
	...
	if(metodoPago == "paypal"){
		...
		$("#cambiarDivisa").append('<option value="COP">COP</option>')
